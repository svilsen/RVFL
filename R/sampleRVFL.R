...
#' @param activation A vector of strings corresponding to activation functions (see \link{control_RVFL} for possible choices). The vector should have length 1, or the length should be equal to the number of hidden layers.
...
#' \describe{
#'     \item{\code{"map"}}{Only the maximum a posterior (MAP) estimate of the weights is returned as an \link{RVFL-object}.}
#'     \item{\code{"stack"}}{The weights are resampled (with replacement) weighted using the unnormalised posterior, creating a stacking based \link{ERVFL-object}.}
#'     \item{\code{"posterior"}}{The posterior distributions of the weights are returned.}
#' }
#' 
#' @return A list of control variables.
#' @export
control_sampleRVFL <- function(N_hidden, lnorm = NULL,
...
#' @param control A list of additional arguments passed to the \link{control_sampleRVFL} function (includes arguments passed to the \link{control_RVFL} function.).
#' 
