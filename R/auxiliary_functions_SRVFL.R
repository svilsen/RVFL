...
#' @title Coefficients of an SRVFL-object.
#' 
#' @param object An \link{SRVFL-object}.
...
#' @title Predicting targets of an SRVFL-object.
#' 
#' @param object An \link{SRVFL-object}.
#' @param ... Additional arguments.
#' 
...
#' 
#' @rdname predict.SRVFL
#' @method predict SRVFL
#' @export
predict.SRVFL <- function(object, ...) {
    dots <- list(...)
...
#' @title Diagnostic-plots of an SRVFL-object.
#' 
#' @param x An \link{SRVFL-object}.
#' @param ... Additional arguments.
#' 
