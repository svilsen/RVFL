...
Lastly, in order to improve their computational and memory efficiency, the \pkg{RWNN} package includes the following methods for pruning the number of weights and neurons: 

- **Global magnitude** (weight pruning): 
- **Uniform magnitude** (weight pruning): 
- **LAMP** (weight pruning): 
- **APoZ pruning** (neuron pruning)
- **L2 ** (neuron pruning): 
- 
