...
implemented in C++ through \pkg{Rcpp} and \pkg{RcppArmadillo}; along
...
efficiency, the \pkg{RWNN} package also includes methods for pruning the
...
\pkg{tune} function found in the package \pkg{e1071}).
...
Lastly, the \pkg{RWNN} package allows the user to specify the activation
